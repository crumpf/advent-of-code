...
//guard let fileInput = FileInput(pathRelativeToCurrentDirectory: "inputs/day/19/example") else { abort() }
guard let fileInput = FileInput(pathRelativeToCurrentDirectory: "inputs/day/19/input") else { abort() }
var startTime = 0.0

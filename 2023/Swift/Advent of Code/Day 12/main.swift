...
//guard let fileInput = FileInput(pathRelativeToCurrentDirectory: "inputs/day/12/example") else { abort() }
guard let fileInput = FileInput(pathRelativeToCurrentDirectory: "inputs/day/12/input") else { abort() }
var startTime = 0.0

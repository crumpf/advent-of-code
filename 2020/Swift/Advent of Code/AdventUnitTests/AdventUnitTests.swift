...
class AdventUnitTests: XCTestCase {
  ...
  func testDay19() throws {
    ...
    let dayPt2 = Day19(input: test2)
    XCTAssertEqual(dayPt2.part2(), "12")
    XCTAssertEqual(dayPt2.part2v2(), "12")
  }
  ...
  func testDay22() throws {
    ...
    10
    """
    let day = Day22(input: test)
    XCTAssertEqual(day.part1(), "306")
    XCTAssertEqual(day.part2(), "291")
  }
  ...
  func testDay25() throws {
    ...
    let day = Day25(input: test)
    XCTAssertEqual(day.part1(), "14897079")
  }
